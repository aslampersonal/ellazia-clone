                    ...
                    <div id="h-nav-div-profile">
                            <NavLink to="./login">
                                <button className="btn" id="login-icon" >
                                    <FaRegUser className='top-icons' alt="Login" title='Login here'/>
                                </button>
                            </NavLink>
                            <NavLink to="./profile">
                                <button className="btn" id="user-icon" >
                                    <FaRegHeart className='top-icons' />
                                    <label>{cartLength ? cartLength: 0}</label>
                                </button>
                            </NavLink>
                            <NavLink to="./cart">
                                <button className="btn" id="cart-icon" >
                                    <CiShoppingCart className='top-icons' style={{fontSize: "30px"}}/>
                                    <label>{cartLength ? cartLength: 0}</label>
                                </button>
                            </NavLink>
                    </div> 
                    ...
                    <div id="h-nav-div-nav">
                        <ul id="h-nav-ul">
                            <li className="h-nav-li">
                                <NavLink className="h-nav-a" to='/offers'>Shop</NavLink>
                            </li>
                            <li className="h-nav-li">
                                <NavLink className="h-nav-a" to="./store">About Us</NavLink>
                            </li>
                            <li className="h-nav-li">
                                <NavLink className="h-nav-a" to="./store">Contact Us</NavLink>
                            </li>
                            <li className="h-nav-li">
